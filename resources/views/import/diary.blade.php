...
<head>
    ...
    <title>Importación Agendas</title>
...
<body>
    <div class="container-fluid">
        <div class="row text-center">
            <div class="col-12">
                <h1 class="h2 py-5 bg-black text-light text-uppercase">Importación Agendas</h1>
            </div>
        ...
        <div class="row">
            <form action="{{ route('importdiary.file') }}" method="POST" enctype="multipart/form-data">
                @csrf
