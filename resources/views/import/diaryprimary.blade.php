...
<head>
    ...
    <title>Importación Agendas Primera</title>
...
<body>
    <div class="container-fluid">
        <div class="row text-center">
            <div class="col-12">
                <h1 class="h2 py-5 bg-black text-light text-uppercase">Importación Agendas Primera</h1>
            </div>
        ...
        <div class="row">
            <form action="{{ route('importdiaryprimary.file') }}" method="POST" enctype="multipart/form-data">
                @csrf
